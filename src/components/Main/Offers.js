    ...
    return (
        <section className='offers'>
            <div className='offers_container container'>
                <Offer title='Diagnoza' text='Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium' image={OfferImg1}/>
                <Offer isRight title='Terapia' text='Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores' image={OfferImg2}/>
